...
#define CVMX_FPA_POOL_1_SIZE (16 * CVMX_CACHE_LINE_SIZE)
#define CVMX_FPA_POOL_2_SIZE (1 * CVMX_CACHE_LINE_SIZE)
#define CVMX_FPA_POOL_3_SIZE (8 * CVMX_CACHE_LINE_SIZE)
#define CVMX_FPA_POOL_4_SIZE (8 * CVMX_CACHE_LINE_SIZE)
...
#define CVM_FPA_TEST_POOL                   (1)             /**< Test buffer pool */
#define CVM_FPA_TEST_POOL_SIZE              CVMX_FPA_POOL_1_SIZE
#define CVMX_FPA_WQE_POOL                   (2)             /**< Work queue entrys */
#define CVMX_FPA_WQE_POOL_SIZE              CVMX_FPA_POOL_2_SIZE
...
#define CVMX_FPA_TIMER_POOL                 (4)             /**< TIM command buffers */
#define CVMX_FPA_TIMER_POOL_SIZE            CVMX_FPA_POOL_4_SIZE
...
#define CVMCS_TEST_BUF_PTR             (0)                  /**< Scratch pad location for test buffer */
#define CVM_SCR_MBUFF_INFO_PTR         (8)                  /**< MBuff information */
#define CVM_DRV_SCR_WQE_BUF_PTR        (16)                 /**< Scratch pad location for WQE buffer pointer */
#define CVM_DRV_SCR_PACKET_BUF_PTR     (24)                 /**< Scratch pad location for Packet pool buffer pointer */
#define CVMX_SCR_SCRATCH               (32)                 /**< Generic scratch iobdma area */
#define CVMX_SCR_REG_AVAIL_BASE        (40)                 /**< First location available after cvmx-config.h allocated region. */
